	...
	private void getInput(){
		...
		if(game.getKeyManager().up){
			if(!(game.getKeyManager().up && game.getKeyManager().right)
				...
				position=10;
				contUp++;
				if(contUp%3==0) position=10;
				if(contUp%3==1) position=11;
				if(contUp%3==2) position=12;
		...
		if(game.getKeyManager().down){	
			if(!(game.getKeyManager().down && game.getKeyManager().right)
				...
				position=2;
				contDown++;
				if(contDown%3==0) position=1;
				if(contDown%3==1) position=2;
				if(contDown%3==2) position=3;
		...
		if(game.getKeyManager().left){
			if(!(game.getKeyManager().left && game.getKeyManager().up)
				...
				position=4;
				contLeft++;
				if(contLeft%3==0) position=4;
				if(contLeft%3==1) position=5;
				if(contLeft%3==2) position=6;
		...
		if(game.getKeyManager().right){	
			if(!(game.getKeyManager().right && game.getKeyManager().up)
				...
				position=9;
				contRight++;
				if(contRight%3==0) position=7;
				if(contRight%3==1) position=8;
				if(contRight%3==2) position=9;
